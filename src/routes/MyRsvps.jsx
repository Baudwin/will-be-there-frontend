export const MyRsvps = () => {
 ...
 <h1 className='text-center font-semibold text-2xl uppercase'>My RSVP'<span className="text-sm">s</span></h1>
                ...
                <div className="border-2 rounded-lg p-3 border-green-900 space-y-2" key={e}>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div>
                                <p className="text-sm">Lorem, ipsum dolor sit amet adipisicing elit. quam quidem cum harum eveniet, soluta quos animi temporibus deserunt quae.</p>
                            </div>
                        </div>
                    </div>
                    {/* location and status  */}
                    ...
                    <span className="text-green-800 font-semibold">Attending</span>
                    </div>
                </div>
            )
        })
